...
class ColoredDoorKeyEnv(HistoricalObsEnv):
    def __init__(
        self,
        minRoomSize: int = 5,
        maxRoomSize: int = 10,
    ...
    def _gen_grid(self, width, height):
        ...
        numKeys = self._rand_int(self.minNumKeys, self.maxNumKeys + 1)
        key = Key(doorColor)
        self.place_obj(key, (topX, topY), (sizeX, sizeY), reject_fn = reject_fn)
        keyColor = 'red'
